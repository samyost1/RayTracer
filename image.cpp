...
void Image::setGrayscale(float brightness, int x, int y) {
    m_colors[y * m_width + x].r = brightness;
    m_colors[y * m_width + x].g = brightness;
    m_colors[y * m_width + x].b = brightness;
}
